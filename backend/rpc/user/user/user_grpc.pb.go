...
func (c *userClient) UpdateProfile(ctx context.Context, in *UpdateProfileReq, opts ...grpc.CallOption) (*CommonResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CommonResp)
...
func (UnimplementedUserServer) UpdateProfile(context.Context, *UpdateProfileReq) (*CommonResp, error) {
